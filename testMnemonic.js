...
const mnemonics = [
    { phrase: process.env.ACCOUNT1_MNEMONIC.trim(), expected: process.env.ACCOUNT1_ADDRESS.trim() },
    { phrase: process.env.ACCOUNT2_MNEMONIC.trim(), expected: process.env.ACCOUNT2_ADDRESS.trim() }
];
